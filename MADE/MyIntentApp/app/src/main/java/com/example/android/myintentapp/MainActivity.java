...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnMoveActivity, btnMoveWithDataActivity, btnDialPhone, btnMoveWithObject;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_move_activity:
                Intent move_intent = new Intent(MainActivity.this, MoveActivity.class);
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "089601867689";
