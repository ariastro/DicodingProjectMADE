...
import com.example.notesapp.entity.NotesItem;

import java.text.DateFormat;
import java.text.SimpleDateFormat;
import java.util.Date;

import static com.example.notesapp.db.DatabaseContract.CONTENT_URI;
...
public class FormActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private NotesItem noteItem = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri != null) {
            ...
            if (cursor != null){
                ...
                if(cursor.moveToFirst()) noteItem = new NotesItem(cursor);
                cursor.close();
            }
        }
