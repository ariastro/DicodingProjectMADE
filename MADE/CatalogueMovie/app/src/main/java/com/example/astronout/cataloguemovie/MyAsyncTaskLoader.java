...
public class MyAsyncTaskLoader extends AsyncTaskLoader<ArrayList<MovieItems>> {
    ...
    public MyAsyncTaskLoader(final Context context, String title) {
        super(context);
        onContentChanged();
        this.mTitle = title;
    }
    ...
    private static final String API_KEY = "342ff6eb6aba54fa4e7acf8eac4eb283";
    ...
    public ArrayList<MovieItems> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/search/movie?api_key=" +
                API_KEY + "&language=en-US&query=" + mTitle;
